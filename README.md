...
- Перешел в аналитику после работы в сфере продаж (e-commerce, retail, B2B, FBO)
-  За числами нахожу данные, которые помогают в развитии продукта.
- Для меня важно находить за числами данные, которые помогут бизнесу расти :chart_with_upwards_trend:.
Поэтому я трансформирую данные в конкретные, измеримые решения, которые повышают ценность продукта и прибыльность, а также дают инсайты для роста бизнеса и принятия правильных управленческих решений.
- Люблю активный отдых (скалолазание, бег, бильярд) и выстраивать свою финансовую стратегию.
- Открыт для сотрудничества! :rocket:
<hr>


### 📫 Свяжитесь со мной:
[![Telegram](https://img.shields.io/badge/Telegram-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/dima_konovalov)
[![Яндекс.Почта](https://img.shields.io/badge/Яндекс.Почта-FF0000?style=for-the-badge&logo=yandex&logoColor=white)](mailto:AlbusKon@yandex.ru)
